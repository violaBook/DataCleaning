...
class Filter_Type():
    ...
    def filter_type(self, filter_type):
        ...
        if match('float', filter_type): # 判数值
            ...
            #     print(self.csv_data[i].dtypes)
            #     if match(self.csv_data[i].dtypes.astype('str'), 'float64')!= None:
            #         print(self.csv_data[i].columns.astype('str'))
            #         # self.col_types.remove(self.csv_data[i].columns.astype('str'))
            #
